...
* You can look at them in the output, or you can have R print them in your Quarto document 
* (Look at the code to see how this was done)
  * n = 30, 95%: [`r round(bern30_95lcl, 3)`, `r round(bern30_95ucl, 3)`]
  * n = 30, 99%: [`r round(bern30_99lcl, 3)`, `r round(bern30_99ucl, 3)`]
  * n = 100, 95%: [`r round(bern100_95lcl, 3)`, `r round(bern100_95ucl, 3)`]
  * n = 100, 99%: [`r round(bern100_99lcl, 3)`, `r round(bern100_99ucl, 3)`]
